...
def builder_parser():
    ...
    parser.add_argument('--build-releases',
                         help = "Build release versions",
                         action="store_true"
                         )

    parser.add_argument('--add-patches',
...
def patcher_parser():
    ...
    # ==================== 
    mut_excl_group.add_argument('--find-range',
    ...
    parser.add_argument('--patch',
                        ...
                        type=str)
    # ==================== 
    mut_excl_group.add_argument('--find-introducer',
